...
def lenet(args, num_layers):
    ...
    # MC dropout
    if (num_nonbayes_layer < 0): model.add(BayesianDropout(args.dropout_rate))
...
def ResNet18(classes, input_shape, args, weight_decay=1e-4, base_filters=64):
...
def VGG11(args, filters=64, dense_out=[512, 512, 100]):
  model = Sequential()
